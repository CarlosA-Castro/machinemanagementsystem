...
-- errorreport: columna problem_type para clasificación de fallas
ALTER TABLE errorreport
  ADD COLUMN problem_type VARCHAR(50) DEFAULT 'mantenimiento';

-- errorreport: columna resolved_at para tracking de resolución
ALTER TABLE errorreport
  ADD COLUMN resolved_at DATETIME DEFAULT NULL;
